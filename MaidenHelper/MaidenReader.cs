    ...
    internal class MaidenReader
    {
        ...
        static void Main()
        {
            ...
            {   
                ...
                Console.WriteLine("Elden Ring Memory Reader");
                string prevStats = "";
                Console.WriteLine("OpenAI Welcome Response HERE!!!!!");
                while (true)
                {
                    string stats = reader.PrintPlayerStats(addresses, idToName).Result;
                    Console.WriteLine(prevStats + "\n" + "Current stats:\n" + stats);
                    prevStats = "Last sent stats:\n" + stats;
                    
                    Console.WriteLine("OpenAI Response HERE!!!!!");
                }
            }
            catch (Exception ex)
            {
